...
describe("scrap iteration flow", () => {
  ...
  test("creates timeout screenshot without recreating existing capture directory", async () => {
    ...
    try {
      ...
      const captureDirectory = path.join(testOwnerRoot, isolated.email, "captures");
